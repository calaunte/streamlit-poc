...
MODEL_OPTIONS = {
    "meta/llama-2-7b-chat": "http://172.17.0.1:8000/v1/chat/completions",
    "nv-mistralai/mistral-nemo-minitron-8b-8k-instruct": "http://172.17.0.1:8080/v1/chat/completions",
}
